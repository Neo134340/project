    ...
    return (
        <div className="min-h-screen bg-white flex justify-center items-center">
            <div className="bg-gray-100 shadow-md rounded-lg px-12 py-10 w-full max-w-md">
                <h2 className="block text-gray-800 text-2xl font-semibold text-center mb-6 uppercase tracking-wider">
                    <span className="text-gray-800">เข้าสู่</span> <span className="text-gray-500">ระบบ</span>
                </h2>
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/register" className="inline-block align-baseline font-medium text-sm text-gray-500 hover:text-gray-800 transition duration-300 ease-in-out">
                            สมัครสมาชิก
                        </Link>
                    </div>
                </form>
